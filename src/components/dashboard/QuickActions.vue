<template>
  ...
  >
      ...
      >
        <div class="flex items-center">
          <div
            ...
            :class="action.iconBg"
          >
            <ActionIcon :icon="action.icon" :class="action.iconColor" />
          </div>
    ...
    <ClientFormModal v-if="showClientModal" :client="null" @close="showClientModal = false" />
  </div>
</template>
...
const ClientFormModal = defineAsyncComponent(
  () => import('../clients/ClientList/ClientFormModal.vue'),
)

// Компонент для иконок действий
