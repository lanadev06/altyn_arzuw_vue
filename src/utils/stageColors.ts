...
// Получить светлый цвет для фона
export function getLightColor(color: string): string {
  // Создаем светлую версию цвета с прозрачностью
  return color + '20' // Добавляем 20% прозрачности
}

// Получить контрастный цвет для текста
export function getContrastColor(color: string): string {
  // Простая логика для определения контрастного цвета
  // Если цвет светлый, возвращаем темный, и наоборот
